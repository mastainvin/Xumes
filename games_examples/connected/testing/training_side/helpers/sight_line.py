...
from games_examples.connected.src.params import HEIGHT, WIDTH
...
class SightLine:
    ...
    def check_collision_pipe(self, pipe):
        ...
        intersections = []
        intersections.extend(line_rect_intersection(self.ball.center, self.end_virtual_position(), tuple(pipe.rect)))

        x_player, y_player = self.ball.center
    ...
    def check_collision_ground(self):
        ...
        intersections = line_rect_intersection(self.ball.center, self.end_virtual_position(), (0, HEIGHT, WIDTH, 10))
    ...
    def check_collision_sky(self):
        ...
        intersections = line_rect_intersection(self.ball.center, self.end_virtual_position(), (0, -10, WIDTH, 10))
