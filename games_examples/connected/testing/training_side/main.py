...
class Game:
	...
	# SOUNDS **********************************************************************
		...
		self.flip_fx = pygame.mixer.Sound(os.path.join(current_dir, 'Sounds', 'flip.mp3'))

		self.score_fx = pygame.mixer.Sound(os.path.join(current_dir, 'Sounds', 'point.mp3'))
		self.dead_fx = pygame.mixer.Sound(os.path.join(current_dir, 'Sounds', 'dead.mp3'))
		self.score_page_fx = pygame.mixer.Sound(
			os.path.join(current_dir, 'Sounds', 'score_page.mp3'))

		pygame.mixer.music.load(os.path.join(current_dir, 'Sounds', 'bgm.mp3'))

	# self.score_fx = pygame.mixer.Sound('Games_examples/connected/Sounds/point.mp3')
	# self.dead_fx = pygame.mixer.Sound('Games_examples/connected/Sounds/dead.mp3')
	# self.score_page_fx = pygame.mixer.Sound('Games_examples/connected/Sounds/score_page.mp3')

	# pygame.mixer.music.load('Games_examples/connected/Sounds/bgm.mp3')
		pygame.mixer.music.play(loops=-1)
		pygame.mixer.music.set_volume(0.5)

	# FONTS ***********************************************************************

		self.title_font = os.path.join(current_dir, 'Fonts/Aladin-Regular.ttf')
		self.score_font = os.path.join(current_dir, 'Fonts/DroneflyRegular-K78LA.ttf')
		self.game_over_font = os.path.join(current_dir, 'Fonts/ghostclan.ttf')
		self.final_score_font = os.path.join(current_dir,
											 'Fonts/DalelandsUncialBold-82zA.ttf')
		self.new_high_font = os.path.join(current_dir, 'Fonts/BubblegumSans-Regular.ttf')
	...
	# Added on July 9th by Jiaqi
		self.easy_img = pygame.image.load(os.path.join(current_dir, 'Assets/easy.jpg'))
		self.hard_img = pygame.image.load(os.path.join(current_dir, 'Assets/hard.jpg'))
		self.home_img = pygame.image.load(os.path.join(current_dir, 'Assets/homeBtn.png'))
		self.replay_img = pygame.image.load(os.path.join(current_dir, 'Assets/replay.png'))
		self.sound_on_img = pygame.image.load(os.path.join(current_dir, 'Assets/soundOnBtn.png'))
