...
from xumes.test_runner.implementations import CommunicationServiceGameMq
...
class TestManager:
    ...
    @abstractmethod
    def _build_game_service(self, test_runner, ip, port) -> TestRunner:
