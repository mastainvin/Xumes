...
from demo.flappy_bird.test.training_side.helpers.lidar import Lidar
from demo.flappy_bird.params import LIDAR_MAX_DIST
...
def train_impl(train_context):
    ...
    train_context.total_timesteps = int(20000)
